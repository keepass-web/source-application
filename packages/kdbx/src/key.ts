/** Derives the encryption/auth keys from the master seed and the
KDF-transformed composite key (spec: "Computation of Keys"). */
...
// HMAC base = SHA-512(masterSeed‖transformedKey‖0x01); derives header/per-block HMAC keys.
